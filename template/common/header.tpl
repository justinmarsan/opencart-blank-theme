...
<head>
	...
	<link rel="stylesheet" type="text/css" href="catalog/view/theme/opencart-blank-theme/stylesheet/stylesheet-remake.css" />
  			...
  			<?php if (count($languages) > 1) { ?>
    					...
    					<div id="currency">
							...
							<br />
      						<?php foreach ($currencies as $currency) { ?>
      							...
      							<?php } else { ?>
      								<?php if ($currency['symbol_left']) { ?>
      									<a title="<?php echo $currency['title']; ?>" onclick="$('input[name=\'currency_code\']').attr('value', '<?php echo $currency['code']; ?>').submit(); $(this).parent().parent().submit();">
  				...
  				<div id="cart">
    				<div class="heading">
      					...
      					<a>
							<span id="cart_total"><?php echo $text_items; ?></span>
						</a>
					</div>
